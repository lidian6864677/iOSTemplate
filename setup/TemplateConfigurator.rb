...
module Pod
  class TemplateConfigurator
    ...
    def hezongyi_rename_project_name
      FileUtils.mv "ExampleDevelop/ExampleDevelop.xcodeproj", "ExampleDevelop/" + @pod_name + "Develop.xcodeproj"
      FileUtils.mv "ExamplePod/ExamplePod.xcodeproj", "ExamplePod/" + @pod_name + "Pod.xcodeproj"
    end
